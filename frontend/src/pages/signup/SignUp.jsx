			...
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				...
				<form onSubmit={handleSubmit}>
					<div>
						...
						<input type='text' placeholder='Please Enter your full name' className='w-full input input-bordered  h-10'
					...
					<div>
						...
						<input type='text' placeholder='Please Enter Desired Username' className='w-full input input-bordered h-10'
